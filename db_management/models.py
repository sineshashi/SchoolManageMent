...
class ParentGaurdian(Model):
    ...
    ifsc_code = fields.CharField(max_length=20, null=True)
    account_holder_name = fields.CharField(max_length=500, null=True)
    address_line1 = fields.TextField(null=True)
    address_line2 = fields.TextField(null=True)
...
class Student(Model):
    ...
    account_holder_name = fields.CharField(max_length=500, null=True)
    address_line1 = fields.TextField()
    address_line2 = fields.TextField()
    address_city = fields.TextField()
    address_country = fields.TextField(default = "India")
    address_code = fields.TextField()
    #Parent and gaurdian details
    father_id = fields.ForeignKeyField("models.ParentGaurdian", "student_of_father", fields.SET_NULL, null=True)
    mother_id = fields.ForeignKeyField("models.ParentGaurdian", "student_of_mother", fields.SET_NULL, null=True)
    gaurdian_id = fields.ForeignKeyField("models.ParentGaurdian", "student_of_gaurdian", fields.SET_NULL, null=True)
...
class SectionSubject(Model):
    ...
    assosiate_subject_teacher = fields.ForeignKeyField("models.InstitiuteStaff", "asstiant_teacher_in_class_subject", fields.SET_NULL, null=True, index=True)
    active = fields.BooleanField(default=True, index=True, null=False)
    created_at = UTCDateTimeField(null=True)
    updated_at = UTCDateTimeField(null=True)
